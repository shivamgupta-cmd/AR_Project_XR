	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 texCoord338 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * IN.ase_color );
				...
				float Occlusion = 1;
				float Alpha = saturate( ( IN.ase_color.a * saturate( ( saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) * vMask354 ) ) ) ).r;
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float cameraDepthFade170 = (( customEye170 -_ProjectionParams.y - _CameraDepthFadeOffset ) / _CameraDepthFadeLength);
				float camDF183 = saturate( cameraDepthFade170 );
				float2 texCoord347 = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * IN.ase_color );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord338 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * IN.ase_color );
				float4 temp_output_346_0 = ( _WaterNormalStrength * vMask354 );
				float3 appendResult138 = (float3(temp_output_346_0.r , temp_output_346_0.r , 1.0));
				float3 WaterNormal140 = ( ( tex2D( _WaterNormal, panner148 ).rgb + tex2D( _WaterNormal, panner143 ).rgb ) * appendResult138 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord338 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner148 = ( 1.0 * _Time.y * _Water01PanSpeed + ( texCoord338 * _Water01UVScale ));
				float2 texCoord344 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner143 = ( 1.0 * _Time.y * _Water02PanSpeed + ( texCoord344 * _Water02UVScale ));
				float2 texCoord347 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 vMask354 = ( saturate( ( saturate( pow( saturate( texCoord347.y ) , _VerticalMaskPower ) ) * _VerticalMaskMultiply ) ) * IN.ase_color );
				float4 temp_output_346_0 = ( _WaterNormalStrength * vMask354 );
				float3 appendResult138 = (float3(temp_output_346_0.r , temp_output_346_0.r , 1.0));
				float3 WaterNormal140 = ( ( tex2D( _WaterNormal, panner148 ).rgb + tex2D( _WaterNormal, panner143 ).rgb ) * appendResult138 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_color.a * saturate( ( saturate( ( saturate( ( DF59 * DSFres181 ) ) * camDF183 ) ) * vMask354 ) ) ) ).r;
...
ASEEND*/
//CHKSM=96412D2FD22CBE4B0A8EDC8F10A9E8713956B620
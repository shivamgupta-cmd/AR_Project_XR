...
Properties
{
    ...
    [Header(River Flow)]
    [Toggle]_EnableFlow("Enable River Flow",Float)=0
    _FlowDirection("Flow Direction X / Y",Vector)=(0,1,0,0)
    _FlowSpeed("Flow Speed",Range(-5,5))=1
    _FlowNormalStrength("Flow Normal Strength",Range(0,2))=1
    _FlowFoamStrength("Flow Foam Strength",Range(0,2))=1
...
SubShader
{
    ...
    Pass
    {
        ...
        V vert(A i)
        {
            ...
            VertexPositionInputs pi =
                GetVertexPositionInputs(p);

            VertexNormalInputs ni =

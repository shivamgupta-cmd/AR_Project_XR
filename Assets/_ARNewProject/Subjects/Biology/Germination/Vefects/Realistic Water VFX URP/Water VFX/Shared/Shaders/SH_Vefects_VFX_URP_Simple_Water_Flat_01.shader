	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float Mask31 = ( tex2DNode16.a * IN.ase_color.a );
				...
				float4 lerpResult24 = lerp( fetchOpaqueVal23 , float4( _Color01.rgb , 0.0 ) , ( _ColorStrength * IN.ase_texcoord4.w ));
...
ASEEND*/
//CHKSM=0F15285983F8272D6B21AE9C9E5B1BF9D0AE96B2
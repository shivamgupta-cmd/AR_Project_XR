	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 objToWorldDir303 = mul( GetObjectToWorldMatrix(), float4( v.normalOS, 0 ) ).xyz;
				float2 texCoord306 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = v.texcoord.z;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord306 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = IN.ase_texcoord8.z;
				float4 tex2DNode94 = tex2D( _Normal, ( panner309 + random305 ) );
				float streamStrength288 = IN.ase_texcoord8.w;
				...
				float op62 = saturate( ( saturate( ( saturate( ( ( ( temp_output_299_0 * streamStrength288 ) * _OpacityMult ) * distanceDepth36 ) ) * saturate( cameraDepthFade111 ) ) ) * IN.ase_color.a ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 objToWorldDir303 = mul( GetObjectToWorldMatrix(), float4( v.normalOS, 0 ) ).xyz;
				float2 texCoord306 = v.ase_texcoord * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = v.ase_texcoord.z;
				float4 tex2DNode94 = tex2Dlod( _Normal, float4( ( panner309 + random305 ), 0, 0.0) );
				float3 WPO314 = ( ( objToWorldDir303 * tex2DNode94.g ) * _WPOStrength );
						 ...
						 ) : SV_TARGET
			{
				...
				float fresnelNode295 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV295 , 0.0001 ), _FresnelPower ) );
				float temp_output_299_0 = saturate( fresnelNode295 );
				float streamStrength288 = IN.ase_texcoord4.w;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth36 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 objToWorldDir303 = mul( GetObjectToWorldMatrix(), float4( v.normalOS, 0 ) ).xyz;
				float2 texCoord306 = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = v.texcoord0.z;
				float4 tex2DNode94 = tex2Dlod( _Normal, float4( ( panner309 + random305 ), 0, 0.0) );
				float3 WPO314 = ( ( objToWorldDir303 * tex2DNode94.g ) * _WPOStrength );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord306 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = IN.ase_texcoord5.z;
				float4 tex2DNode94 = tex2D( _Normal, ( panner309 + random305 ) );
				float streamStrength288 = IN.ase_texcoord5.w;
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , ( _NormalIntensity * streamStrength288 ));
				float3 norm100 = lerpResult235;
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord306 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner309 = ( 1.0 * _Time.y * _NormalUVPanSpeed + ( texCoord306 * _NormalUVScale ));
				float random305 = IN.ase_texcoord3.z;
				float4 tex2DNode94 = tex2D( _Normal, ( panner309 + random305 ) );
				float streamStrength288 = IN.ase_texcoord3.w;
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , ( _NormalIntensity * streamStrength288 ));
				float3 norm100 = lerpResult235;
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float fresnelNode295 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV295 , 0.0001 ), _FresnelPower ) );
				float temp_output_299_0 = saturate( fresnelNode295 );
				float streamStrength288 = IN.ase_texcoord2.w;
...
ASEEND*/
//CHKSM=49DBBAD4E52AF7BBB69B2E01E4E8340EDFB0D372
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 WPO200 = ( ( tex2Dlod( _WPOTexture, float4( panner197, 0, 0.0) ).g * ( v.normalOS * _WPOStrength ) ) * ( 1.0 - saturate( texCoord205.y ) ) );
...
ASEEND*/
//CHKSM=77226AA540FA95B89981E3D525B3FFFDE9FF6C7A
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord1_g25 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float op62 = saturate( ( saturate( ( saturate( ( ( saturate( tex2DNode94.a ) * _OpacityMult ) * distanceDepth36 ) ) * saturate( cameraDepthFade111 ) ) ) * IN.ase_color.a ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord1_g25 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord1_g25 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
				float3 lerpResult235 = lerp( float3(0,0,1) , tex2DNode94.rgb , _NormalIntensity);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord1_g25 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g25 = (float2(_TilingX , 1.0));
				float2 appendResult5_g25 = (float2(( _TimeParameters.x * 3.0 ) , 0.0));
				float4 tex2DNode94 = tex2D( _HoseTextureNormal, ( float3( ( ( texCoord1_g25 * appendResult4_g25 ) + appendResult5_g25 ) ,  0.0 ) + float3( 0,0,0 ) ).xy );
...
ASEEND*/
//CHKSM=A93B9E03A63F1B751B4C8FECA778FD33248CE184